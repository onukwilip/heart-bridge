    ...
    <>
      <div className="w-full flex flex-col gap-5">
        ...
        >
          ...
          <label
            htmlFor="image"
            className="w-full p-3 flex gap-3 rounded-lg border border-weak-grey items-center cursor-pointer transition hover:border-primary-grey"
          >
            {/* Image container + icon + overlay */}
            <div className="w-[50px] h-[50px] overflow-hidden rounded-full relative text-white before:w-full before:h-full before:rounded-full before:absolute before:top-0 before:left-0 before:bg-black/50 before:z-[5]">
              <Image
                width={50}
                height={50}
              ...
              />
              <i className="fa-solid fa-camera-retro absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-xl z-20"></i>
            </div>
            <span>
              {form_state.image
